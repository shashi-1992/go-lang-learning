...
Imagine the function above would work and we pass multiple arguments. Then all those arguments will get assigned to a and nothing would be assigned to b. Hence, variadic parameter must be provided at the end.
